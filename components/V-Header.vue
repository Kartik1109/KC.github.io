...
const subtitleText = 'Software Developer Intern';
    ...
    <div class="header__container">
      <h1 class="header__container__title">
        <span class="header__container__title__line">
          <span class="header__container__title__line__content">Kartik</span>
        </span>
        <span
          class="header__container__title__line header__container__title__line--pl"
        >
          <span class="header__container__title__line__content">Chaudhari</span>
        </span>
      </h1>
